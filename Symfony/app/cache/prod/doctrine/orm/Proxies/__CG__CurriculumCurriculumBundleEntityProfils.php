...
namespace Proxies\__CG__\Curriculum\CurriculumBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Profils extends \Curriculum\CurriculumBundle\Entity\Profils implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Curriculum\\CurriculumBundle\\Entity\\Profils' . "\0" . 'id', '' . "\0" . 'Curriculum\\CurriculumBundle\\Entity\\Profils' . "\0" . 'profil', '' . "\0" . 'Curriculum\\CurriculumBundle\\Entity\\Profils' . "\0" . 'competences');
        }
