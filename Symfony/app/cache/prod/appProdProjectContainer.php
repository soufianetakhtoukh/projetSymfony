...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Curriculum\\CurriculumBundle\\Entity'))), 'Curriculum\\CurriculumBundle\\Entity');
        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('CurriculumBundle' => 'Curriculum\\CurriculumBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Curriculum\\CurriculumBundle/Resources/views'), 'Curriculum');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('04cb9534fff7eb3385757daba6a40562eae252f7');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('571d3ea91f666')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CurriculumBundle' => 'Curriculum\\CurriculumBundle\\CurriculumBundle',
            ),
            ...
            'secret' => '04cb9534fff7eb3385757daba6a40562eae252f7',
            'locale' => 'en',
            ...
            'kernel.secret' => '04cb9534fff7eb3385757daba6a40562eae252f7',
